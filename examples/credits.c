...
struct txt_share txtquad_update(struct txt_frame frame, struct txt_buf *txt)
{
	...
	int numchars = 11; // strlen(credit); 
	char *credit; 
	credit = malloc(numchars * sizeof(char)); 
	credit = "SNELL'S LAW"; 
